...
import { ArrowLeft, ArrowDown, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="max-w-lg mx-auto px-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        {processing ? (
          <button
            disabled
            className="w-full bg-green text-black font-semibold py-3 rounded-md opacity-50 cursor-not-allowed flex items-center justify-center gap-2"
          >
